const CACHE_NAME = 'ersenbox-v9';
const STATIC_ASSETS = ['./', './index.html'];
const CACHE_HOSTS = ['cdn.jsdelivr.net','quran.islam-db.com','raw.githubusercontent.com','cdn.islamic.network','fonts.googleapis.com','fonts.gstatic.com'];
